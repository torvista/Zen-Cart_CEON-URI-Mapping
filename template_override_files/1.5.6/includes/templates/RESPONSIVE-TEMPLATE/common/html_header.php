...
if (in_array($current_page_base,explode(",",'popup_image,popup_image_additional')) ) {
  ...
  if ( $detect->isMobile() && !$detect->isTablet() || /*isset($_SESSION['layoutType']) &&*/ $_SESSION['layoutType'] == 'mobile' ) {
    echo $responsive_mobile;
  } else if ( $detect->isTablet() || /*isset($_SESSION['layoutType']) &&*/ $_SESSION['layoutType'] == 'tablet' ){
    echo $responsive_tablet;
  } else if ( /*isset($_SESSION['layoutType']) &&*/ $_SESSION['layoutType'] == 'full' ) {
    echo '';
  } else {
