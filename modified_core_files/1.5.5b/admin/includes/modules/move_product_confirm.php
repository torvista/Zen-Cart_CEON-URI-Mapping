...
if (!defined('IS_ADMIN_FLAG')) {
  die('Illegal Access');
        ...
        if ($duplicate_check->fields['total'] < 1) {
          ...
          $ceon_uri_mapping_admin->moveProductConfirmHandler($products_id, zen_get_products_type((int)$products_id),
            $zc_products->get_handler(zen_get_products_type((int)$products_id)), $new_parent_id);
