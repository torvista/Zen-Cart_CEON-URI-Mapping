...
//auto replace with defined missing image
            ...
            if ($_POST['image_delete'] == 1 || $products_image_name == '' and PRODUCTS_IMAGE_NO_IMAGE_STATUS == '1') {
              echo zen_image(DIR_WS_CATALOG_IMAGES . PRODUCTS_IMAGE_NO_IMAGE, zen_output_string_protected($pInfo->products_name), SMALL_IMAGE_WIDTH, SMALL_IMAGE_HEIGHT, 'align="right" hspace="5" vspace="5"') . zen_output_string_protected($pInfo->products_description);
            } else {
              echo zen_image(DIR_WS_CATALOG_IMAGES . $products_image_name, zen_output_string_protected($pInfo->products_name), SMALL_IMAGE_WIDTH, SMALL_IMAGE_HEIGHT, 'align="right" hspace="5" vspace="5"') . zen_output_string_protected($pInfo->products_description);
            }
          ?>
        </td>
      </tr>
