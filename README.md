...
## 25/12/2025: developers please use the branch "storefront_IDE": it has many minor IDE-based changes (but no code/functionality changes) for whitespace, short array syntax, type hints, some formatting, short form keywords, some strict comparisons, elseif, str_contains, str_ends_with, str_starts_with AND some fixes for strict types. strict types are not used in these files, just my personal set. Still testing... Merry Xmas!
