...
class zcObserverCeonAskAQuestion extends base
{
    public function __construct()
    {
        ...
        $this->attach($this, ['NOTIFY_HEADER_START_ASK_A_QUESTION']);
    }
     ...
     **/
    public function notify_header_start_ask_a_question(&$cClass, $notifier): void
    {
    ...
    public function updateNotifyHeaderStartAskAQuestion(&$cClass, $notifier): void
    {
     ...
     **/
    public function update(&$cClass, $notifier): void
    {
        $this->notify_header_start_ask_a_question($cClass, $notifier);
    }
}
