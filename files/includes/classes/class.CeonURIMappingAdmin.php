 ...
 * @version     $Id: class.CeonURIMappingAdmin.php 28 Jan 2026 torvista
 */
...
class CeonURIMappingAdmin extends CeonURIMappingDBLookup
{
	...
	protected function _loadAutogenerationSettings(): void
    {
		...
		if (!$load_autogen_settings_result->EOF) {
			...
			$this->_language_code_add = $load_autogen_settings_result->fields['language_code_add'] === '1' ? 1 : 0;
     ...
     *                    clashing mapping.
     */
	protected function _autoLanguageCodeAdd(): bool
    {
		return (bool)$this->_language_code_add;
	}
