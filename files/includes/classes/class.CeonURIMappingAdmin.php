 ...
 * @version     $Id: class.CeonURIMappingAdmin.php 25 Dec 2025 torvista
 */
...
class CeonURIMappingAdmin extends CeonURIMappingDBLookup
{
	...
	public function addURIMapping(
        string $uri, $language_id = null, ?string $main_page = null, ?string $query_string_parameters = null,
	...
	protected function _convertStringForURI(string $text, string $language_code, bool $strip_slashes = true): string
    {
        ...
        //TODO IDE reports redundant slashes, review
		if ($strip_slashes) {
			$pattern = '/[\|\/\+_:;\(\)\[\]\<\>,]/';
		} else {
			$pattern = '/[\|\+_:;\(\)\[\]\<\>,]/';
