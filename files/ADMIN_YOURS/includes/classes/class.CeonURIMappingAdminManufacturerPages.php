 ...
 * @version     $Id: class.CeonURIMappingAdminManufacturerPages.php 1054 2012-09-22 15:45:15Z conor $
 */
...
class CeonURIMappingAdminManufacturerPages extends CeonURIMappingAdminManufacturers
{
	 ...
	 * @return  none
	 */
	function insertSaveHandler($manufacturer_id, $manufacturer_name)
	{
		global $messageStack;
	 ...
	 * @return  none
	 */
	function deleteConfirmHandler($manufacturer_id)
	{
		$query_string_parameters = 'manufacturers_id=' . (int) $manufacturer_id;
	 ...
	 * @return  none
	 */
	function addURIMappingFieldsToAddManufacturerFieldsArray()
	{
		global $contents;
	 ...
	 * @return  none
	 */
	function addURIMappingFieldsToEditManufacturerFieldsArray($manufacturer_id)
	{
		global $contents;
	 ...
	 */
	function buildManufacturerURIMappingFields($prev_uri_mappings)
	{
		global $languages;
