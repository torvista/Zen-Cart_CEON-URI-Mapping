 ...
 * @version     $Id: class.CeonURIMappingAdminProductPages.php 1054 2012-09-22 15:45:15Z conor $
 */
...
class CeonURIMappingAdminProductPages extends CeonURIMappingAdminProducts
{
	 ...
	 * @access  protected
	 */
	var $_autogeneration_errors = array();
	 ...
	 */
	function collectInfoBuildURIMappingFields()
	{
		global $languages;
	 ...
	 * @return  none
	 */
	function productPreviewProcessSubmission($current_category_id)
	{
		global $db;
	 ...
	 * @return  none
	 */
	function productPreviewInitialLoad($product_id, $product_type)
	{
	 ...
	 * @return  none
	 */
	function productPreviewOutputURIMappingInfo($language_info)
	{
		?>
		  <tr>
		  ...
		  <tr>
			<td style="padding-top: 0.5em; padding-bottom: 0.5em; border-top: 1px solid #003d00; border-bottom: 1px solid #003d00;">
			  <table border="0" width="100%" cellspacing="0" cellpadding="2">
				...
				if ((!is_null($this->_uri_mappings[$language_info['id']]) &&
	 ...
	 * @return  none
	 */
	function productPreviewBuildHiddenFields()
	{
		global $languages;
	 ...
	 * @return  none
	 */
	function updateProductHandler($product_id, $product_type)
	{
	 ...
	 */
	function buildProductCopyURIMappingFields($product_id)
	{
	 ...
	 * @return  none
	 */
	function copyToConfirmHandler($product_id_from, $product_id_to, $product_type_id, $product_type,
		$dest_category_id)
	{
	 ...
	 * @return  none
	 */
	function addURIMappingFieldsToProductMoveFieldsArray($product_id)
	{
		global $contents;
	 ...
	 * @return  string|boolean   The source for the input fields or false if no input fields necessary.
	 */
	function buildProductMoveURIMappingFields($product_id)
	{
		global $db, $languages, $ceon_uri_mapping_product_pages;
	 ...
	 * @return  none
	 */
	function moveProductConfirmHandler($product_id, $product_type_id, $product_type, $dest_category_id)
	{
		global $db, $messageStack;
